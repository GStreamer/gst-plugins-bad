...
typedef enum
{
  ...
  GST_PHOTOGRAPHY_COLOUR_TONE_MODE_POSTERIZE,
  GST_PHOTOGRAPHY_COLOUR_TONE_MODE_WHITEBOARD,
  GST_PHOTOGRAPHY_COLOUR_TONE_MODE_BLACKBOARD,
  GST_PHOTOGRAPHY_COLOUR_TONE_MODE_AQUA
} GstColourToneMode;
