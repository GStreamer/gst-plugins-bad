...
/**
 * GstWebRTCSignallingState:
 * GST_WEBRTC_SIGNALLING_STATE_STABLE: stable
 * GST_WEBRTC_SIGNALLING_STATE_CLOSED: closed
 * GST_WEBRTC_SIGNALLING_STATE_HAVE_LOCAL_OFFER: have-local-offer
 * GST_WEBRTC_SIGNALLING_STATE_HAVE_REMOTE_OFFER: have-remote-offer
 * GST_WEBRTC_SIGNALLING_STATE_HAVE_LOCAL_PRANSWER: have-local-pranswer
 * GST_WEBRTC_SIGNALLING_STATE_HAVE_REMOTE_PRANSWER: have-remote-pranswer
 *
 * See http://w3c.github.io/webrtc-pc/#dom-rtcsignalingstate
 */
typedef enum /*< underscore_name=gst_webrtc_signalling_state >*/
{
  GST_WEBRTC_SIGNALLING_STATE_STABLE,
  GST_WEBRTC_SIGNALLING_STATE_CLOSED,
  GST_WEBRTC_SIGNALLING_STATE_HAVE_LOCAL_OFFER,
  GST_WEBRTC_SIGNALLING_STATE_HAVE_REMOTE_OFFER,
  GST_WEBRTC_SIGNALLING_STATE_HAVE_LOCAL_PRANSWER,
  GST_WEBRTC_SIGNALLING_STATE_HAVE_REMOTE_PRANSWER,
} GstWebRTCSignallingState;
