...
/*static guint gst_arts_signals[LAST_SIGNAL] = { 0 }; */
        GType gst_arts_get_type (void)
        {
          static GType gst_arts_type = 0; if (!gst_arts_type) {
          ...
          sizeof (GstARTSClass),
            ...
            gst_arts_type =
            g_type_register_static (GST_TYPE_ELEMENT, "GstArts",
                &gst_arts_info, 0);}
        ...
        GstARTS * arts = (GstARTS *) element;
          g_return_if_fail (arts != NULL); gst_arts_wrapper_do (arts->wrapper);}

        static gboolean plugin_init (GstPlugin * plugin)
        {
          if (!gst_element_register (plugin, "gstarts", GST_RANK_NONE,
                  GST_TYPE_ARTS))
